...
export const project2 = {
  ...
  body: `<p id="carouselItemDescription" className="fs-5 font-weight-normal text-dark">Queens Road Garage is elegant page with well selected and slick animations.<br/>Main features:
                    <ul>
                        <li>Responsive layout</li>
                        <li>Available in two languages (EN & PL)</li>
                        <li>Contact form</li>
                        <li>Fraud and abuse free by reCAPTCHA</li>
                        <li>Provide clear information to customer</li>
                    </ul>
                </p>`,
